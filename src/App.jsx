...
export default function App() {
  ...
  // initially itself it is getting rendered 2 times
  // Don't know why....
    ...
    const questionDataArray = questionArrayFromApi.map((question) => {
      ...
      const optionObject = option.map((option) => {
        ...
        return {
          ...
          optionValue: option,
          isHeld: false,
          isCorrect: option === question.correct_answer ? true : false,
        };
      });
      return {
        ...question,
  ...
  React.useEffect(() => {
    fetch("https://opentdb.com/api.php?amount=5&type=multiple")
      .then((res) => res.json())
      // .then((data) => )
      .then((data) => setQuestions(makeQuestionObjectArray(data.results)));
        ...
        <div className="home-page-div">
          ...
          <div className="home-page-components">
            <p className="description">
              The quiz consists of {questions.length} single correct multiple
              choice question{questions.length > 1 ? "s" : ""}.
            </p>
          </div>
          <div className="home-page-components">
        ...
        <main className="quiz-questions-page">
          ...
          <div className="all-question">
            ...
            <div className="play-again-button-and-score">
              <div className="score">
                <h3>
                  You scored {score}/{questions.length} correct answer
                  {score > 1 ? "s" : ""}{" "}
                </h3>
              </div>
